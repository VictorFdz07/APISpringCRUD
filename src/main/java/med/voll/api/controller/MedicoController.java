...
public class MedicoController {
    ...
    @PostMapping
    public ResponseEntity<DatosRespuestaMedico> regisrarMedico(@RequestBody @Valid DatosRegistroMedico datosRegistroMedico, UriComponentsBuilder uriComponentsBuilder){
        ...
        // Return 201 Created
        // URL donde encontrar al nuevo registro
